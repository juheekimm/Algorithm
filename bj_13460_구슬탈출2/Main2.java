...
//				if (d == temp.d) continue;
				...
				Node r, b;
				//빨간거 먼저 이동 
//				System.out.println("r " + temp.rx + " " + temp.ry);
//				System.out.println("b " + temp.bx + " " + temp.by);
//				System.out.println();
				if (firstMoveCheck(temp, d)) {
//					System.out.println("나");
					r = move(new Node(temp.rx, temp.ry), temp.d, false);
					
//					System.out.println("rrr" + r.rx + " " + r.ry);
					if (r.rx == -1 && r.ry == -1) {
						b = move(new Node(temp.bx, temp.by, -1, -1, 0, 0), temp.d, false);
//						System.out.println("파랑이동 r " + temp.rx + " " + temp.ry);
					}
					else
						b = move(new Node(temp.bx, temp.by, temp.rx, temp.ry, 0, 0), temp.d, true);
					
				} else {
//					System.out.println("너");
					b = move(new Node(temp.bx, temp.by), temp.d, false);
					if (b.rx == -1 && b.ry == -1)
						r = move(new Node(temp.rx, temp.ry, -1, -1, 0, 0), temp.d, false);
					else
						r = move(new Node(temp.rx, temp.ry, temp.bx, temp.by, 0, 0), temp.d, true);
				}
//				System.out.println();
//				System.out.println("r " + temp.rx + " " + temp.ry);
//				System.out.println("b " + temp.bx + " " + temp.by);
...
//				if (r.rx == -1 && r.ry == -1)	//파랑은 안빠지고 빨강만 빠진 경우 
//					return temp.count;
